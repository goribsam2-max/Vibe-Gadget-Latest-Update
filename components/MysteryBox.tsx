  ...
  return (
    <>
      ...
      >
          ...
          <span className="mt-1.5 bg-white/90 backdrop-blur-md px-2.5 py-0.5 rounded text-[9px] font-black uppercase tracking-widest text-purple-900 shadow-sm border border-purple-100">Mystery Box</span>
      </motion.div>
        ...
        {isOpen && (
          ...
          >
            ...
            >
              ...
              <button onClick={handleClose} className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center bg-zinc-100 rounded-full hover:bg-zinc-200 transition-colors">
              ...
              {result === 'win' && revealedProduct ? (
                ...
                <div className="py-8">
                  <div className="w-24 h-24 mx-auto bg-zinc-100 rounded-full flex items-center justify-center mb-6">
                    <Icon name="frown" className="text-4xl text-zinc-400" />
                  </div>
                  <h3 className="font-black text-xl text-zinc-900 mb-2 tracking-tight">Better Luck Next Time</h3>
                  ...
                  <button 
                    onClick={handleClose}
                    className="w-full py-4 bg-zinc-900 text-white rounded-2xl font-black uppercase tracking-widest text-[11px] shadow-lg hover:bg-black active:scale-95 transition-all"
                  >
                    Got It
                  </button>
                </div>
