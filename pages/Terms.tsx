  ...
  return (
    <div className="p-6 md:p-12 pb-24 animate-fade-in bg-white max-w-4xl mx-auto min-h-screen">
       ...
       <div className="space-y-8 text-sm md:text-base leading-relaxed text-zinc-600">
          <section>
             <h2 className="text-black font-black text-xl mb-4">1. Acceptance of Terms</h2>
          ...
          <section>
             <h2 className="text-black font-black text-xl mb-4">2. Returns & Refunds Policy</h2>
          ...
          <section>
             <h2 className="text-black font-black text-xl mb-4">3. Warranty Information</h2>
          ...
          <section>
             <h2 className="text-black font-black text-xl mb-4">4. Account Security</h2>
