  ...
  return (
    <div className="p-6 md:p-12 pb-24 animate-fade-in bg-white max-w-4xl mx-auto min-h-screen">
       ...
       <div className="space-y-8 text-sm md:text-base leading-relaxed text-zinc-600">
          <section>
             <h2 className="text-black font-black text-xl mb-4">Welcome to VibeGadget</h2>
          ...
          <section>
             <h2 className="text-black font-black text-xl mb-4">Why We Are Trusted</h2>
          ...
          <section>
             <h2 className="text-black font-black text-xl mb-4">Our Commitment</h2>
