            ...
            <form onSubmit={handleSave} className="space-y-8">
                ...
                <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-zinc-200 shadow-sm relative overflow-hidden">
                    <div className="flex items-center mb-6">
                        ...
                        <div>
                            <h2 className="font-black text-lg text-zinc-900">Branding & PWA</h2>
                            ...
                            <div className="flex items-center space-x-4">
                                {seoData.faviconUrl ? (
                                    <div className="relative group w-12 h-12 shrink-0">
                                       <img src={seoData.faviconUrl} className="w-full h-full object-cover rounded-lg border border-zinc-200 shadow-sm" alt="favicon" />
                                    ...
                                    <div className="w-12 h-12 bg-zinc-50 rounded-lg border border-zinc-200 flex items-center justify-center shrink-0">
                            ...
                            <div className="flex items-center space-x-4">
                                {seoData.appIconUrl ? (
                                    <div className="relative group w-16 h-16 shrink-0">
                                       <img src={seoData.appIconUrl} className="w-full h-full object-cover rounded-2xl border border-zinc-200 shadow-sm" alt="app icon" />
                                    ...
                                    <div className="w-16 h-16 bg-zinc-50 rounded-2xl border border-zinc-200 flex items-center justify-center shrink-0">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                className="w-full bg-zinc-50 border border-zinc-200 rounded-xl p-4 text-xs font-mono text-zinc-800 focus:border-emerald-500 transition-colors resize-none"
                            />
